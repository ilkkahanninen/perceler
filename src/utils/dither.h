...
static const unsigned char dither_voidcluster8x8[64] = {
    13, 39,  8, 52, 22, 56, 32, 44,
    50, 24, 58, 28,  4, 36, 17, 10,
    30,  2, 46, 16, 48, 14, 62, 42,
    54, 38, 20, 34, 60, 26,  6, 23,
     9, 63, 11, 55,  0, 40, 51, 35,
    45, 18, 41, 25, 43, 19, 15, 57,
    27,  5, 53, 12, 31, 61,  3, 37,
    33, 59, 21, 47,  7, 49, 29, 46
};
